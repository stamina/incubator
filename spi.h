...
// SPR [1:0] of SPCR  and SPI2X bit of SPSR register decides frequency of SCK.
// The combination of these three bits will be used to select SCK frequency
...
void spi_init(uint8_t speed, uint8_t mode, uint8_t bitorder, uint8_t interrupt);
